...
import { TicketContext, TicketProvider } from "@/context/ticket-context/index"
...
const agents = [
  { id: 1, name: "Liam", photo: "/images/profile/user-1.jpg" },
        ...
        <div className="flex flex-wrap items-center justify-between mt-6 gap-3">
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              onClick={() => navigate({to: "/apps/tickets"})}
            >
              Cancel
            </Button>
          </div>
